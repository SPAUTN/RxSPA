...
void Api::config(String dbHost, String dbUser, String dbPass) {
    this -> dbHost = dbHost;
    this -> dbUser = dbUser;
    this -> dbPass = dbPass;
}

void Api::setDebugLevel(String debugLevel) {
    this -> debugLevel = debugLevel;
}

String Api::getDebugLevel() {
    return this -> debugLevel;
}

String Api::sendFrameData(String frame, String table, int attempts){
    int n_attemp = 0;
...
String Api::getWeightAndRain(String command) {
    HTTPClient http;
